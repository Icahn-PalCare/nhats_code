...
frmttable using "E:\nhats\projects\IAH\housecalls_weighted.doc", replace statmat(tab1) ///
...
if `cpt'==1 local t "2"
if `cpt'==0 local t "3"
frmttable using "E:\nhats\projects\IAH\housecalls_weighted.doc", addtable statmat(tab1) ///
varlabels title("Table `t': IAH Unique persons per NHATS Waves 1-3 Community Dwelling + 6m FFS (Weighted) & `housecall'") ///
...
if `cpt'==0 local housecall "No Housecalls"
frmttable using "E:\nhats\projects\IAH\housecalls_weighted.doc", addtable statmat(tab1) ///
varlabels title("Table 4: IAH Unique persons per NHATS Waves 1-3 Community Dwelling + 6m FFS (Weighted) & `housecall'") ///
