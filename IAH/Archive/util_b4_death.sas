...
So if missing, set var to 0*/
 ...
 label ind_nonelect_adm_6m="Ind any non-elective hospital admission 6m pre death";

 n_nonelect_adm_6m=(n_ip_admit_6m - n_elect_admit_6m);
 label n_nonelect_adm_6m="total n non-elective ip admit 6m pre death";

 if n_ED_ip_6m=0 then ind_ED_adm_6m=0;
 if n_ED_ip_6m>0 & n_ED_ip_6m~=. then ind_ED_adm_6m=1;
 label ind_ED_adm_6m="Ind ED use with hospital admission 6m pre death, from charges";
...
if n_snf_days_6m=0 then ind_snf_use_6m=0;
 ...
 label ind_snf_use_6m="Indicator for any SNF stay 6m pre death";
 label n_snf_days_6m="SNF Days 6m pre death";
...
label n_ed_op_visits_6m="Count ED OP visits, 6m pre death";

if n_ed_op_visits_6m=0 then ind_ed_op_6m=0;
if n_ed_op_visits_6m>0 & n_ed_op_visits_6m~=. then ind_ed_op_6m=1;
label ind_ed_op_6m="Indicator any ED OP visits, 6m pre death";
