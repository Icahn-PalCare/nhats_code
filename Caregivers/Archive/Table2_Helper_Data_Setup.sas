...
table eligible complete total_hours;
run;
...
as select a.*, b.hours_helped, b.count_helpers, b.num_spouse, b.num_daug, b.num_son, b.num_oth_fam, b.num_paid_cg, b.num_other_nofam,
