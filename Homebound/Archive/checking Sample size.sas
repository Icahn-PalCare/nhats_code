...
run;
proc freq data=nsoc_eligible_helpers1;
where family_member = 0;
table paid_caregiver;
run;
proc freq data=nsoc_eligible_helpers1;
where family_member = 0 and paid_caregiver = 0;
table NSOC_Eligible;
run;

data nsoc_eligible_helpers2;
set nsoc_eligible_helpers1;
if family_member = 0 and paid_caregiver = 0 and NSOC_Eligible = -1;
run;
data testing1;
set nsoc_eligible_helpers1;
if any_help = 0;
...
/************ testing to make sure that the 10 had no helpers *************/

proc sql;
create table SP_No_Help
as select a.*, b.NSOC_Eligible
from Nhats_wave1_tab1_test3 a
left join helper_test_nsoc_elig b
on a.spid = b.spid;
quit;
data sp_no_help1;
set sp_no_help;
...
data op_no_help;
set nhats_r1_op;
if spid = 10000010 | spid = 10000446 | spid = 10001457 | spid = 10001668 | spid = 10003468 | spid = 10004613 | spid = 10005873 | 
spid = 10006193 | spid = 10006336 | spid = 10007897;
run;
